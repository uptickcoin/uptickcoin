...
libs = [
    'libuptickcoin_cli',
    'libuptickcoin_common',
    'libuptickcoin_crypto',
    'libuptickcoin_server',
    'libuptickcoin_util',
    'libuptickcoin_wallet_tool',
    'libuptickcoin_wallet',
    'libuptickcoin_zmq',
    'bench_uptickcoin',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/uptickcoin_config.h'), os.path.join(SOURCE_DIR, 'config/uptickcoin-config.h'))
