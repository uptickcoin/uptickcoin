...
// uptickcoin includes.
#include <..\src\script\uptickcoinconsensus.h>
...
int main()
{
    std::cout << "uptickcoinconsensus version: " << uptickcoinconsensus_version() << std::endl;
    ...
    auto op0Result = uptickcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, uptickcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
