...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the uptickcoin repository."
  exit 1
fi
...
# See https://github.com/uptickcoin/uptickcoin/issues/16064
...
echo 'When compiling uptickcoind, run `./configure` in the following way:'
echo
