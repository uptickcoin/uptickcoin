...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_uptickcoin` executable (see https://github.com/uptickcoin/uptickcoin/pull/13543),
...
options will be passed to uptickcoin's configure. In this case, `--disable-wallet`.
