Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://uptickcoin.org/bin/uptickcoin-core-0.10.4/>
...
- #6953 `43c2789` Split uptickcoin-tx into its own package
- #6953 `dfe0d4d` Include uptickcoin-tx binary on Debian/Ubuntu
