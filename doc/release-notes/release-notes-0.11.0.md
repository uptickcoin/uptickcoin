Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://uptickcoin.org/bin/uptickcoin-core-0.11.0/>
...
For example, add the following to `uptickcoin.conf`:
...
related to the blockchain in the uptickcoin system: the raw blocks as received over 
...
For an example script see [uptickcoin-submittx](https://github.com/laanwj/uptickcoin-submittx).
...
- #5334 `cf87536` libuptickcoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new uptickcoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add uptickcoin logo to about screen
...
- #5809 `46bfbe7` Add uptickcoin-cli man page
...
- #5849 `41259ca` contrib/init/uptickcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for uptickcoin-tx)
