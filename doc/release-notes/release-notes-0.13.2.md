Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://uptickcoin.org/bin/uptickcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update uptickcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow uptickcoin-tx to create v2 transactions (BTCdrak)
