Bitcoin Core version 0.16.3 is now available from:
  ...
  <https://uptickcoincore.org/bin/uptickcoin-core-0.16.3/>
...
### Miscellaneous
- #13655 `1cdbea7` uptickcoinconsensus: invalid flags error should be set to `uptickcoinconsensus_err` (afk11)
