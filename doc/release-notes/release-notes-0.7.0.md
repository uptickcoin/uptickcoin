Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/uptickcoin/files/Bitcoin/uptickcoin-0.7.0/

We recommend that everybody running prior versions of uptickcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/uptickcoin/uptickcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/uptickcoin/uptickcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the uptickcoin-qt package:
  sudo apt-get install uptickcoin-qt
...
Core uptickcoin handling and blockchain database
...
* Ensure a changed uptickcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for uptickcoin-qt.exe
* (Windows only): add meta-data to uptickcoin-qt.exe (e.g. description)
...
* Bash programmable completion for uptickcoind(1)
