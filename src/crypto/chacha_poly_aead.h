...
/* A AEAD class for ChaCha20-Poly1305@uptickcoin.
 *
 ...
 *
 * The chacha20-poly1305@uptickcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@uptickcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@uptickcoin are relatively fast in
