    ...
    mapper(nullptr)
{
    ...
    ui->uptickcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->uptickcoinAtStartup);
    ...
    ui->uptickcoinAtStartup->setToolTip(ui->uptickcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->uptickcoinAtStartup->setText(ui->uptickcoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->uptickcoinAtStartup, OptionsModel::StartAtStartup);
