...
{
    BOOST_CHECK(TestSplitHost("www.uptickcoincore.org", "www.uptickcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.uptickcoincore.org]", "www.uptickcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.uptickcoincore.org:80", "www.uptickcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.uptickcoincore.org]:80", "www.uptickcoincore.org", 80));
