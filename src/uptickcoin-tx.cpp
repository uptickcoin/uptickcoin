...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " uptickcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  uptickcoin-tx [options] <hex-tx> [commands]  Update hex-encoded uptickcoin transaction\n" +
            "or:     uptickcoin-tx [options] -create [commands]   Create hex-encoded uptickcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded uptickcoin transaction
