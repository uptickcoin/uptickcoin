...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    {
       nSubsidy = 45000000 * COIN; // 4,500,000,000 UTC (Pre-mine/Insta-mine)
    }
    else if(nHeight<=2628100)
    {
        nSubsidy = 900 * COIN; // 2,365,200,000 UTC in 2628000 blocks
    }
    else if(nHeight<=5256100)
    {
        nSubsidy = 450 * COIN; // 1,182,600,000 UTC in 2628000 blocks
    }
    else if(nHeight<=7884100)
    {
        nSubsidy = 225 * COIN; // 591,300,000 UTC in 2628000 blocks
    }
    else if(nHeight<=9460900)
    {
        nSubsidy = 112.5 * COIN; // 177,390,000 UTC in 1576800 blocks
    }
    else if(nHeight<=10512100)
    {
        nSubsidy = 56.25 * COIN; // 59,130,000 UTC in 1051200 blocks
    }
    else if(nHeight<=1294934500)
    {
        nSubsidy = 28.125 * COIN; // 36,124,380,000 UTC  in 1284422400 blocks
    }
    else
    {
        nSubsidy = 0 * COIN;
