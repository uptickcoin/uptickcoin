...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/uptickcoin/uptickcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/uptickcoin/uptickcoin/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g uptickcoin-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/uptickcoin/uptickcoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-uptickcoin-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g uptickcoin-wallet), tx confirmation
 ...
 * https://uptickcointalk.org/?topic=54527, or
 * https://github.com/uptickcoin/uptickcoin/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //UTCTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeUTCs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeUTCs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeUTCs(true, connman, mempool);
}
