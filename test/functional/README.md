...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The Travis linter also checks this, but [possibly not in all cases](https://github.com/uptickcoin/uptickcoin/pull/14884#discussion_r239585126).
...
with the uptickcoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a uptickcoind.  `P2PInterface`
...
Taken from the [python-uptickcoinrpc repository](https://github.com/jgarzik/python-uptickcoinrpc).
...
Basic code to support P2P connectivity to a uptickcoind.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-uptickcoinlib)
