...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.uptickcoind,
            self.options.uptickcoind,
            releases_path + "/v0.19.0.1/bin/uptickcoind",
            releases_path + "/v0.18.1/bin/uptickcoind",
            releases_path + "/v0.17.1/bin/uptickcoind"
        ], binary_cli=[
            self.options.uptickcoincli,
            self.options.uptickcoincli,
            releases_path + "/v0.19.0.1/bin/uptickcoin-cli",
            releases_path + "/v0.18.1/bin/uptickcoin-cli",
            releases_path + "/v0.17.1/bin/uptickcoin-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes uptickcoind to exit, in addition to the RPC
