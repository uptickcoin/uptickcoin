...
"""Verify that starting uptickcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start uptickcoin with -h for help text")
        ...
        self.log.info("Start uptickcoin with -version for version information")
        ...
        self.log.info("Start uptickcoind with -fakearg to make sure it does not start")
